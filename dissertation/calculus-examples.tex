...
\begin{align*}
  ...
  &\to_{\beta.\to} \case{(2 / 0)}{z}{\ap{\eta}{z}}{\_}{\dbze} \\
...
\begin{align*}
  ...
  &\to_{\eta.\hsbind} \ap{(\lam{x}{\dbze \hsbind (\lam{y}{\ap{\eta}
          {(x \times y)}})})}{3} \\
  &\to_{\beta.\to} \dbze \hsbind (\lam{y}{\ap{\eta} {(3 \times y)}}) \\
...
\begin{align*}
  ...
  &\to_{\beta.\to} (\ap{\eta}{0}) \hsbind (\lam{y}{\ap{\eta}{(5 + y)}}) \\
  &\to_{\eta.\hsbind} \ap{(\lam{y}{\ap{\eta}{(5 + y)}})}{0} \\
  &\to_{\beta.\to} \ap{\eta}{(5 + 0)} \\
  &\to_+ \ap{\eta}{5}
\end{align*}
...
& = \app{(\lam{X Y}{X \hsbind (\lam{x}{Y \hsbind (\lam{y}{\ap{\eta}{(x + y)}})})})}
        {(\ap{\op{get}!}{\bar{x}})}
        {(\ap{\op{get}!}{\bar{y}})} \\
& \to_{\beta.\to,\beta.\to} (\ap{\op{get}!}{\bar{x}}) \hsbind (\lam{x}{
                       (\ap{\op{get}!}{\bar{y}}) \hsbind (\lam{y}{
                        \ap{\eta}{(x + y)}})}) \\
& = (\ap{(\lam{x}{\app{\op{get}}{x}{\eta}})}{\bar{x}}) \hsbind (\lam{x}{
    (\ap{\op{get}!}{\bar{y}}) \hsbind (\lam{y}{
     \ap{\eta}{(x + y)}})}) \\
& \to_{\beta.\to} (\app{\op{get}}{\bar{x}}{\eta}) \hsbind (\lam{x}{
    (\ap{\op{get}!}{\bar{y}}) \hsbind (\lam{y}{
     \ap{\eta}{(x + y)}})}) \\
...
&\to_{\beta.\to,\beta.\to} \lam{Y}{(\ap{\eta}{2}) \hsbind (\lam{x}{\ap{\banana{\onto{\op{get}}{(\lam{u k}{\ifte{u = \bar{y}}{(\ap{k}{x})}{(\app{\op{get}}{u}{k})}})}}}{Y}})} \\
&\to_{\eta.\hsbind} \lam{Y}{\ap{(\lam{x}{\ap{\banana{\onto{\op{get}}{(\lam{u k}{\ifte{u = \bar{y}}{(\ap{k}{x})}{(\app{\op{get}}{u}{k})}})}}}{Y}})}{2}} \\
&\to_{\beta.\to} \lam{Y}{\ap{\banana{\onto{\op{get}}{(\lam{u k}{\ifte{u = \bar{y}}{(\ap{k}{2})}{(\app{\op{get}}{u}{k})}})}}}{Y}} \\
...
\begin{description}
  ...
  \item[Line 4 ($\to_{\banana{\op{op}},\beta.\to}$)] The let-binder is a
    ...
    performed a $\beta.\to$ reduction. This is part of a pattern we will
    ...
    immediately $\beta.\to$ reduce away the second one to get
    $\app{f}{x}{(\lam{y}{\ap{\banana{\onto{\op{op}}{f}}}{M}})}$. By
    composing the $\banana{\op{op}}$ rule and the $\beta.\to$ rule, we can
  ...
  \item[Line 5 ($\beta.\to$)] Here we apply the handler clause to the
  ...
  \item[Line 8 ($\beta.\to$)] We have simplified the handler clause and so
  ...
  \item[Line 10 ($\banana{\op{op}},\beta.\to$)] We have another $\op{get}$
  ...
  \item[Line 11 ($\beta.\to$)] We pass the variable $\bar{y}$ into the
  ...
  \item[Line 14 ($\beta.\to$)] Having simplified the handler clause, we can
    pass in the continuation so that we can supply it with the value of the
    variable $bar{y}$ that it was looking for.

  \item[Line 15 ($\beta.\to$)] We pass $2$ to the continuation.
