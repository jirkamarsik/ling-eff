...
= \app{\op{scope}}{(\lam{k}{\ap{F_1}{(\lam{x}{\ap{F_2}{(\lam{y}{\ap{k}{(x,y)}})}})}})}{(\lam{(x,y)}{M(x,y)})}
$$
...
$$
\app{\op{scope}}{(\lam{k}{\exists y.\ \ap{\obj{cat}}{y} \land \ap{k}{y}})}
{(\lam{y}{\app{\op{scope}}{(\lam{k}{\forall x.\ \app{\obj{own}}{x}{y} \to \ap{k}{x}})}
{(\lam{x}{\etaE{x}})}})}
$$
