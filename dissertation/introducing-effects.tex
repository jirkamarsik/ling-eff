...
$1$. Operations such as this can be though of as \emph{getters}, their
purpose is to retrieve something from the context.
...
usually be less important, i.e.\ the trivial type $1$. This pattern will be
particularly for smuggling out non-at-issue content (implicatures and
presuppositions).
...
\item Conventional implicature.
  ...
  of the at-issue proposition and all the implicated propositions.
