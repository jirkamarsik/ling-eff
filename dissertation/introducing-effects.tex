...
\begin{align*}
&\ap{\TTDL}{(\sem{\appp{\abs{verb}}{\abs{owns}}{(\ap{\abs{a}}{(\ap{\abs{noun}}{\abs{Porsche}})})}{(\ap{\abs{a}}{(\ap{\abs{noun}}{\abs{man}})})}} \andlr \sem{\appp{\abs{verb}}{\abs{fascinates}}{\abs{him}}{\abs{it}}})} \\
...
As with the previous phenomena, we can study which computations have always
equal interpretations given our choice of handlers and establish an
equational theory. Though before we do that, we will address one dimension
in the design of our dynamics analysis that we have omitted so far.
