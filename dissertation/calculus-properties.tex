...
In Chapter~\ref{chap:definitions}, we have introduced both a type systems
and a reduction semantics for $\banana{\lambda}$. Now we will give more
substance to these two definitions by proving properties which outline 
...
\begin{lemma}\label{lem:compositionality-types}
  \demph{Compositionality of $\banana{\lambda}$ types}
