...
\begin{proof}
  ...
  \hsbind
  (\lam{m}{\ap{\op{\shift}!}{(\lam{x}{\ap{\resetbanana}{(\ap{m}{(\eta \circ
            x)})}})}})$.
  ...
  \resizebox{1.7\linewidth}{!}{
    ...
    \AxiomC{$\sem{\Gamma}, x : \sem{\tau} \to \sem{\gamma} \vdash x : \sem{\tau} \to \sem{\gamma}$}
    \RightLabel{[$\circ$]}
    \BinaryInfC{$\sem{\Gamma}, x : \sem{\tau} \to \sem{\gamma} \vdash \eta \circ x : \sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})$}
    \RightLabel{[app]}
    \BinaryInfC{$\sem{\Gamma}, m : (\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma}), x : \sem{\tau} \to \sem{\gamma} \vdash \ap{m}{(\eta \circ x)} : \cstype(\sem{\gamma})$}
    \RightLabel{[app]}
    \BinaryInfC{$\sem{\Gamma}, m : (\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma}), x : \sem{\tau} \to \sem{\gamma} \vdash \ap{\resetbanana}{(\ap{m}{(\eta \circ x)})} : \sem{\gamma}$}
    \RightLabel{[abs]}
    \UnaryInfC{$\sem{\Gamma}, m : (\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma}) \vdash \lam{x}{\ap{\resetbanana}{(\ap{m}{(\eta \circ x)})}} : (\sem{\tau} \to \sem{\gamma}) \to \sem{\gamma}$}
    \RightLabel{[$\op{op}!$]}
    \UnaryInfC{$\sem{\Gamma}, m : (\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma}) \vdash \ap{\op{\shift}!}{(\lam{x}{\ap{\resetbanana}{(\ap{m}{(\eta \circ x)})}})} : \cstype(\sem{\tau})$}
    \RightLabel{[abs]}
    \UnaryInfC{$\sem{\Gamma} \vdash \lam{m}{\ap{\op{\shift}!}{(\lam{x}{\ap{\resetbanana}{(\ap{m}{(\eta \circ x)})}})}} : ((\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma})) \to \cstype(\sem{\tau})$}
    \RightLabel{[$\hsbind$]}
    \BinaryInfC{$\sem{\Gamma} \vdash \sem{M'} \hsbind (\lam{m}{\ap{\op{\shift}!}{(\lam{x}{\ap{\resetbanana}{(\ap{m}{(\eta \circ x)})}})}}) : \cstype(\sem{\tau})$}
    \DisplayProof
  }}
  \vspace{2mm}
\end{proof}
