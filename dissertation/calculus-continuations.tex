...
\begin{align}
  ...
  &\from_{\eta} \app{\op{shift0}}{v}{(\lam{x}{\ap{\eta}{x}})} \\
...
\sem{\semo{M}}
&= \sem{\semo{\ap{\shift}{M'}}} \\
&= \sem{\ap{\shifto}{(\ap{(\lam{m}{\lam{k}{\ap{\reseto}{(\ap{m}{k})}}})}{\semo{M'}})}} \\
&= \sem{\ap{(\lam{m}{\lam{k}{\ap{\reseto}{(\ap{m}{k})}}})}{\semo{M'}}} \hsbind (\lam{n}{\ap{\op{shift0}!}{n}}) \\
&= ((\ap{\eta}{(\lam{m}{\sem{\lam{k}{\ap{\reseto}{(\ap{m}{k})}}}})}) \hsbind (\lam{f}{\sem{\semo{M'}} \hsbind (\lam{a}{\ap{f}{a}})})) \hsbind (\lam{n}{\ap{\op{shift0}!}{n}}) \\
&\to_{\eta.\hsbind,\beta,\beta} (\sem{\semo{M'}} \hsbind (\lam{a}{\sem{\lam{k}{\ap{\reseto}{(\ap{a}{k})}}}})) \hsbind (\lam{n}{\ap{\op{shift0}!}{n}}) \\
&\to_{\hsbind.\hsbind} \sem{\semo{M'}} \hsbind (\lam{a}{\sem{\lam{k}{\ap{\reseto}{(\ap{a}{k})}}} \hsbind (\lam{n}{\ap{\op{shift0}!}{n}})}) \\
&= \sem{\semo{M'}} \hsbind (\lam{a}{(\ap{\eta}{(\lam{k}{\sem{\ap{\reseto}{(\ap{a}{k})}}})}) \hsbind (\lam{n}{\ap{\op{shift0}!}{n}})}) \\
&\to_{\eta.\hsbind,\beta} \sem{\semo{M'}} \hsbind (\lam{a}{\ap{\op{shift0}!}{(\lam{k}{\sem{\ap{\reseto}{(\ap{a}{k})}}})}}) \\
&= \sem{\semo{M'}} \hsbind (\lam{a}{\ap{\op{shift0}!}{(\lam{k}{\ap{\resetobanana}{\sem{\ap{a}{k}}}})}}) \\
&\tto \sem{\semo{M'}} \hsbind (\lam{a}{\ap{\op{shift0}!}{(\lam{k}{\ap{\resetobanana}{(\ap{a}{k})}})}}) \\
&= \sem{\semo{M'}} \hsbind (\lam{m}{\ap{\op{shift0}!}{(\lam{k}{\ap{\resetobanana}{(\ap{m}{k})}})}}) \\
&= \sem{M'} \hsbind (\lam{m}{\ap{\op{shift0}!}{(\lam{k}{\ap{\resetobanana}{(\ap{m}{k})}})}}) \\
&= \sem{\ap{\shift}{M'}} \\
&= \sem{M}
\end{align}
\setcounter{equation}{0}
...
\begin{proof}
  ...
  \item $M = \ap{M_1}{M_2}$
    ...
    Proof tree given in~\ref{fig:big-proof-tree-app}.
  ...
  \item $M = \ap{\reset}{M'}$
    ...
    Proof tree given in~\ref{fig:big-proof-tree-reset}.
  ...
  The induction hypothesis gives us $\sem{\Gamma} \vdash \sem{M'} :
  \cstype((\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to
  \cstype(\sem{\gamma}))$. We also have $\sem{\ap{\shift}{M'}} = \sem{M'}
  \hsbind
  (\lam{m}{\ap{\op{\shift}!}{(\lam{k}{\ap{\resetbanana}{(\ap{m}{(\eta \circ
            k)})}})}})$.
  
  Proof tree given in~\ref{fig:big-proof-tree-shift}.
...
\begin{sidewaysfigure}
  ...
  \begin{subfigure}{\textwidth}
    ...
    \caption{\label{fig:big-proof-tree-app} The case for $M = \ap{M_1}{M_2}$.}
  \end{subfigure}
  ...
  \begin{subfigure}{\textwidth}
      ...
      \DisplayProof
      \caption{\label{fig:big-proof-tree-reset} The case for $M = \ap{\reset}{M'}$.}
  \end{subfigure}
  ...
  \resizebox{1.1\textwidth}{!}{
    ...
    \AxiomC{$\sem{\Gamma} \vdash \resetbanana : \cstype(\sem{\gamma}) \to \sem{\gamma}$}
    ...
    \AxiomC{$\sem{\Gamma} \vdash \eta : \sem{\gamma} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})$}
    \AxiomC{$\sem{\Gamma}, k : \sem{\tau} \to \sem{\gamma} \vdash k : \sem{\tau} \to \sem{\gamma}$}
    \RightLabel{[$\circ$]}
    \BinaryInfC{$\sem{\Gamma}, k : \sem{\tau} \to \sem{\gamma} \vdash \eta \circ k : \sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})$}
    \RightLabel{[app]}
    \BinaryInfC{$\sem{\Gamma}, m : (\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma}), k : \sem{\tau} \to \sem{\gamma} \vdash \ap{m}{(\eta \circ k)} : \cstype(\sem{\gamma})$}
    \RightLabel{[app]}
    \BinaryInfC{$\sem{\Gamma}, m : (\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma}), k : \sem{\tau} \to \sem{\gamma} \vdash \ap{\resetbanana}{(\ap{m}{(\eta \circ k)})} : \sem{\gamma}$}
    \RightLabel{[abs]}
    \UnaryInfC{$\sem{\Gamma}, m : (\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma}) \vdash \lam{k}{\ap{\resetbanana}{(\ap{m}{(\eta \circ k)})}} : (\sem{\tau} \to \sem{\gamma}) \to \sem{\gamma}$}
    \RightLabel{[$\op{op}!$]}
    \UnaryInfC{$\sem{\Gamma}, m : (\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma}) \vdash \ap{\op{\shift}!}{(\lam{k}{\ap{\resetbanana}{(\ap{m}{(\eta \circ k)})}})} : \cstype(\sem{\tau})$}
    \RightLabel{[abs]}
    \UnaryInfC{$\sem{\Gamma} \vdash \lam{m}{\ap{\op{\shift}!}{(\lam{k}{\ap{\resetbanana}{(\ap{m}{(\eta \circ k)})}})}} : ((\sem{\tau} \to \FF_{E_{\sem{\delta}}}(\sem{\gamma})) \to \cstype(\sem{\gamma})) \to \cstype(\sem{\tau})$}
    \RightLabel{[$\hsbind$]}
    \BinaryInfC{$\sem{\Gamma} \vdash \sem{M'} \hsbind (\lam{m}{\ap{\op{\shift}!}{(\lam{k}{\ap{\resetbanana}{(\ap{m}{(\eta \circ k)})}})}}) : \cstype(\sem{\tau})$}
    \DisplayProof
  }}
