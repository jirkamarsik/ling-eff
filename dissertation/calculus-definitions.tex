...
\begin{figure}
  \pstree{\Tcircle{a}}{\pstree{\Tf{b}}{\Toval{c}\pstree{\Tf{d}}{\Toval{e}}}\pstree{\Tf{f}}{\Toval{g}\pstree{\Tf{h}}{\Toval{i}}}}
  \begin{tikzpicture}
    \GraphInit[vstyle=Normal]
    \SetGraphUnit{2}
    \Vertex[L=$\lambda$]{preRoot}
    \SOWE[L=$\op{op}_1(M_1)$](preRoot){Aop1}
    \SOEA[L=$\op{op}_1(M_1)$](preRoot){Bop1}
    \Edge(preRoot)(Aop1)
    \Edge(preRoot)(Bop1)
    \begin{scope}
      \SetGraphUnit{1.5}
      \SOWE[L=$A_1$](Aop1){A1}
      \SOEA[L=$\op{op}_2(M_2)$](Aop1){Aop2}
      \SO[L=$A_2$](Aop2){A2}
      \SOWE[L=$B_1$](Bop1){B1}
      \SOEA[L=$\op{op}_2(M_2)$](Bop1){Bop2}
      \SO[L=$B_2$](Bop2){B2}
      \Edge(Aop1)(A1)
      \Edge(Aop1)(Aop2)
      \Edge(Aop2)(A2)
  ...
  \caption{\label{fig:c-illustration} Example of applying the $\CC$
    ...
    $\op{op}_1$ is binary and the output of $\op{op}_2$ is unary.}
\end{figure}
