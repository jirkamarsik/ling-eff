...
\TODO{Mention Lewis' ``What should meanings do instead of what should
  meanings be.'' somewhere?}
...
\begin{align*}
  ...
  &\to_{\beta} \ap{\ap{\op{op}}{x}}{\eta} \hsbind k \\
...
$$
\banana{(\onto{\op{op}_i} M_i)_{i \in I}} = \banana{(\onto{\op{op}_i}{M_i})_{i \in I},\ \onto{\eta}{(\lam{x}{\etaE{x}})}}
$$
