...
\item Setting the Monads
  ...
  shifters. When given a sentence, the grammar then assigns a reading to
  every possible way of gluing the meanings of the parts of the sentence in
  a type-sound way. There is therefore no need to define any supermonad to
