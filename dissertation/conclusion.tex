...
\item Applicative Abstract Categorial
  ...
  the fact that, unlike monads, applicatives are
  composable.\footnote{However, the applicative structure that one gets by
  ...
  languages are defined to be so-called \emph{T-languages} which admit only
  constants a binary application operator. 
