...
in some other languages (closed handlers and the $\hsbind$ operator) are
defined within $\calc$ and their typing rules and reduction rules are
derived from those of $\calc$. In Section~\ref{sec:type-soundness}, we
prove \emph{subject reduction} of $\calc$. This result gives a basic
...
longer be reduced must have a very specific shape.
