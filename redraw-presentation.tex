...
\begin{frame}{Example from Linguistics}
  \begin{adjustbox}{center}
   \begin{tabular}{|c|c|c|} \hline
    ...
    \visible<3->{$\lambda P e \phi. P j e \phi$} &
    \visible<3->{\begin{tabular}{@{}c@{}}$\lambda P e \phi. [\forall x. (boy\ x) \rightarrow$ \\
      $P\ x\ e\ (\lambda e'. \top)] \land \phi\ e$ \end{tabular}} &
    ...
    \visible<6->{\includepicture{john}} & \visible<6->{\includepicture{everyboy}} & \visible<6->{\includepicture{she}} \\ \hline
  \end{tabular}
  \end{adjustbox}
\end{frame}
